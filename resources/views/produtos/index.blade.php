                                        ...
                                        <form method="POST" action="{{ route('produtos.update', $produto->id) }}">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <h6 class="text-start mb-3">Informações do Produto</h6>
                                                    <div class="row">
                                                        @php
                                                            $camposProduto = [
                                                        ...
                                                        <div class="col-md-4 mb-2">
                                                            <label class="form-label text-start w-100">Manufaturado</label>
                                                        ...
                                                        <div class="col-md-4 mb-2">
                                                            <label class="form-label text-start w-100">Sazonal</label>
                                                    ...
                                                    <h6 class="text-start mb-3">Embalagem</h6>
                                                    <div class="row">
                                                        @php
                                                        ...
                                                        <div class="col-md-4 mb-2">
                                                            <label class="form-label text-start w-100">Caixa Fechada</label>
                                                        ...
                                                        <div class="col-md-4 mb-2">
                                                            <label class="form-label text-start w-100">Controle de Estoque</label>
