...
<div class="modal fade" id="editarTransportadoraModal-{{ $transportadora->id }}" tabindex="-1">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-2">
                            ...
                            <select name="ativo" class="form-control">
                                <option value="Sim" {{ $transportadora->ativo === 'Sim' ? 'selected' : '' }}>Sim</option>
                                <option value="Não" {{ $transportadora->ativo === 'Não' ? 'selected' : '' }}>Não</option>
                            </select>
                        </div>
                    </div>
                </div>
